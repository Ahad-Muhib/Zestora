...
8. Serve with berries and maple syrup''',
    ...
    for recipe_data in recipes_data:
        ...
        print(f'Recipe: {recipe.title} - Created: {created}')
    ...
    for cat_data in tip_categories_data:
        ...
        print(f'Tip Category: {category.name} - Created: {created}')
    ...
    for tip_data in tips_data:
        ...
        print(f'Tip: {tip.title} - Created: {created}')
    ...
    for story_data in stories_data:
        ...
        print(f'Story: {story.title} - Created: {created}')
